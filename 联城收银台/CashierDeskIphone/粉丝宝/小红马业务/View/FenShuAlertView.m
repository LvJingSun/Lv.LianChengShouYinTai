...
@interface FenShuAlertView () <UITableViewDelegate,UITableViewDataSource> {
...
@implementation FenShuAlertView
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    Choose_FenShuCell *cell = [[Choose_FenShuCell alloc] init];
    
    Choose_FenShuFrame *frame = self.array[indexPath.row];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    self.choosefenshu(frame.fenshumodel);
