...
//    NSString *objName = [NSString stringWithUTF8String:object_getClassName(sourceArr[0])];
    
//    if ([objName isEqualToString:@"UpShopModel"]) {
//        
//        UpShopModel *model = [sourceArr lastObject];
//        
//        firstImageView.image = [UIImage imageNamed:model.imageName];
//        
...
//        if ([objName isEqualToString:@"UpShopModel"]) {
//            
//            UpShopModel *model = [sourceArr objectAtIndex:i];
//            
//            firstImageView.image = [UIImage imageNamed:model.imageName];
//            
...
//    if ([objName isEqualToString:@"UpShopModel"]) {
//        
//        UpShopModel *model = [sourceArr objectAtIndex:0];
//        
//        firstImageView.image = [UIImage imageNamed:model.imageName];
//        
