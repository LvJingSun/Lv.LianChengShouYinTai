...
@implementation Choose_StaffCell

+ (instancetype)Choose_StaffCellWithTableview:(UITableView *)tableview {

    static NSString *cellID = @"Choose_StaffCell";
    
    Choose_StaffCell *cell = [tableview dequeueReusableCellWithIdentifier:cellID];
    
    if (cell == nil) {
        
        cell = [[Choose_StaffCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
-(void)setFrameModel:(Choose_StaffFrame *)frameModel {
...
- (void)setContent {
    ...
    Choose_StaffModel *model = self.frameModel.staffmodel;
