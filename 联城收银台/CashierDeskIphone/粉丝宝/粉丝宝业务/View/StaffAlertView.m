...
@interface StaffAlertView () <UITableViewDelegate,UITableViewDataSource> {
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    Choose_StaffCell *cell = [[Choose_StaffCell alloc] init];
    
    Choose_StaffFrame *frame = self.array[indexPath.row];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    self.choosestaff(frame.staffmodel);
