...
// 添加值来区分扫描来自哪个页面  1是key值扫描 2是手机号码扫描
@property (nonatomic, assign) int     m_type;

- (id)initWithDelegate:(id<ZXingDelegate>)delegate showCancel:(BOOL)shouldShowCancel OneDMode:(BOOL)shouldUseoOneDMode withType:(int)aType;
