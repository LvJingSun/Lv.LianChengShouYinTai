...
@interface ConsoleViewController : BaseViewController<UITextFieldDelegate,UITableViewDataSource,UITableViewDelegate,ZXingDelegate,PullTableViewDelegate,UIAlertViewDelegate>{
